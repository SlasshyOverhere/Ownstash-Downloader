        ...
        >
            ...
            <motion.div variants={fadeInUp} className="flex gap-2 p-1 rounded-xl bg-muted/30" role="tablist" aria-label="History categories">
                <button
                    ...
                    className={cn(
                        'flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-lg transition-all outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background',
                        activeTab === 'downloads'
            ...
            <motion.div variants={fadeInUp} className="flex gap-3">
                ...
                {activeTab === 'downloads' && (
                    <div className="flex items-center gap-1 glass rounded-xl p-1" role="radiogroup" aria-label="Filter downloads by status">
                        {(['all', 'completed', 'failed'] as const).map((status) => (
                            <button
                                ...
                                className={cn(
                                    'px-4 py-2 rounded-lg text-sm font-medium capitalize transition-all outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background',
                                    filterStatus === status
                                        ? 'bg-white text-black'
