...
// ⚡ Bolt Optimization: Memoize DownloadHistoryCard to prevent unnecessary re-renders
// of the entire list when filter or search state updates.
...
// ⚡ Bolt Optimization: Memoize SearchHistoryCard to prevent unnecessary re-renders
// of the entire list when search state updates.
...
export function HistoryPage() {
    ...
    // This allows the memoized child components to accurately skip rendering.
