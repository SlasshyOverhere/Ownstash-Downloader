                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1 text-xs text-muted-foreground mt-1 flex-wrap">
                        ...
                        <span className={cn(
                            ...
                            item.status === 'failed' && 'text-white/50'
                        )}>
                            {item.status}
                        </span>
                    </div>
                ...
                <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
                    {item.path && (
                        <button
                            ...
                            className="p-2 rounded-lg hover:bg-primary/20 text-primary transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background outline-none"
                    ...
                    <button
                        ...
                        aria-label="Copy URL"
                        className="p-2 rounded-lg hover:bg-white/10 transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background outline-none"
                        title="Copy URL"
                    >
                    ...
                    <button
                        ...
                        className="p-2 rounded-lg hover:bg-destructive/20 text-destructive transition-colors focus-visible:ring-2 focus-visible:ring-destructive focus-visible:ring-offset-2 focus-visible:ring-offset-background outline-none"
...
const SearchHistoryCard = memo(function SearchHistoryCard({ item, onSelect }: SearchHistoryCardProps) {
    ...
    return (
        ...
        >
            <div className="flex items-center gap-4">
                {/* Thumbnail */}
                <div className="w-20 h-14 rounded-xl bg-gradient-to-br from-white/10 to-white/5 flex items-center justify-center shrink-0 overflow-hidden">
                    {item.thumbnail ? (
                        <img
                            src={item.thumbnail}
