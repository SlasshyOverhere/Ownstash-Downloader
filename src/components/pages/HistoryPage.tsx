...
export function HistoryPage() {
    ...
    const handleClearDownloads = useCallback(async () => {
        const confirmed = await confirm('Are you sure you want to clear all download history?', {
    ...
    const handleClearSearchHistory = useCallback(async () => {
        const confirmed = await confirm('Are you sure you want to clear all search history?', {
