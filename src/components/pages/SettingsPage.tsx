...
function Toggle({ checked, onChange, 'aria-label': ariaLabel }: ToggleProps) {
    return (
        <button
            ...
            className={cn(
                'w-11 h-6 rounded-full transition-colors relative focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-black',
            ...
            >
                <div className="space-y-3">
                    ...
                    <SettingRow
                        ...
                        action={
                            <Toggle
                                aria-label="Remove Sponsors with SponsorBlock"
